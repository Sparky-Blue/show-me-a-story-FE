...
const audioControl = function(options) {
  ...
  var play = function(buffer, callback) {
    ...
    fileReader.onload = function() {
      // Once we have an ArrayBuffer we can create our BufferSource and decode the
      // result as an AudioBuffer.
      ...
      audioRecorder.audioContext().decodeAudioData(this.result, function(buf) {
        ...
        // Set the destination (the actual audio-rendering device--your device's
        // speakers).
